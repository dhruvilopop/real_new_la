...
const STEPS = [
  ...
  { id: 8, title: 'Review', icon: ClipboardList, description: 'Final review & submit' },
];
  ...
  const validateCurrentStep = (): boolean => {
    ...
    switch (currentStep) {
      ...
      case 4:
        ...
        else if (parseFloat(loanForm.monthlyIncome) <= 0) errors.monthlyIncome = 'Income must be greater than 0';
        break;
      case 5:
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <Input id="employerName" value={loanForm.employerName} onChange={(e) => setLoanForm({...loanForm, employerName: e.target.value})} placeholder="Company name" />
              </div>
